...
- [ ] Escrever `tests/web/test_business_context.py` e
...
- [ ] Implementar o protocolo da spec e passagem opcional nos três módulos
...
- [ ] Escrever RED de integração em `tests/web/test_business_context_runtime.py`
...
- [ ] Escrever RED de alegações hostis em
  `tests/web/test_real_qwen_narration_regressions.py`, demonstrar a falha e commitar.
...
- [ ] Fixar os três blobs autorizados em `.github/workflows/phase12-web-demo.yml`.
